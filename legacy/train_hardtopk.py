...
if __name__ == "__main__":
    ...
    my_config.env.acs_train_w_align = 0.0
    ...
    my_config.env.continuous_action = False  # BINARY hard top-K
    ...
    custom_model_config = {
        ...
        "continuous_action": False,  # BINARY
        "top_k": 10,
        "hard_top_k": True,          # HARD top-K binary selection
        "dist_aux_coef": 1.0,
        "per_agent_credit": False,
    }

    # register model. For BINARY mode, do NOT register/use beta_dist
    # (beta_dist is only for continuous_action). The default action dist
    # handles the binary [-s,+s] categorical-per-edge logits.
